      ...
      <div className="grid-x grid-padding-x u-margin-large--tb">
        <div className="small-12 medium-6 large-5 cell">
          <h3 className="h5">
            TBD
            <br />
            <span className="subheader">Brussels, 6 July &mdash; 16 July</span>
          </h3>
          {/*
          ...
          <div className="loading loading--map u-margin--b">
            ...
            */}
            <iframe
              ...
              marginHeight="0"
              marginWidth="0"
              src="https://www.openstreetmap.org/export/embed.html?bbox=4.352624416351319%2C50.842722493832355%2C4.3622803688049325%2C50.84820293447596&amp;layer=mapnik&amp;"
              style={{ width: '100%', height: '250px' }}
            />
      ...
      <div className="grid-x grid-padding-x u-margin-large--tb">
        <div className="small-12 medium-6 large-5 cell">
          <h3 className="h5">
            ...
            TBD
            <br />
            <span className="subheader">Brussels, 20 July &mdash; 30 July</span>
          </h3>
          {/*
          <p className="u-margin--t">
