    ...
    <div>
      <div className="grid-x grid-padding-x u-margin-large--tb">
        <div className="small-12 cell">
          ...
          <p>On Mondays and Thursdays we work in <strong>Brussels</strong>, on Tuesdays and Wednesdays <strong>hybrid</strong>. You don&apos;t have to work on Fridays, holidays or weekends!</p>
