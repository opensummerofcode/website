          ...
          <div className="c-faq__item">
            ...
            <div className="c-faq__item__answer">
              <p>
                ...
                under the supervision of several experienced coaches. Secondly, since you’ll be
                making a real product or service, it looks great on your resume and you’ll expand
                your network. Thirdly, you’ll surely make some new friends too.
              </p>
              <p>
                Sounds awesome, no? And we didn’t even get to the best part yet: osoc is completely
                free. Even better, you are getting paid! This programme could replace your summer
                job. Enhancing your skills, making new friends and cashing in some money too? Sounds
          ...
          <div className="c-faq__item">
            ...
            <div className="c-faq__item__answer">
              <p>
                ...
                impact. Over the last few years, students have got the opportunity to work on open
                innovation projects in different fields such as mobility, education, health, sports
                and biodiversity. Check out <a href="2018.html">this year&apos;s edition</a> to see
                what kind of projects have been built by osoc students at the latest edition.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="cell small-11 medium-8 large-6">
          <div className="c-faq__item">
            ...
            <div className="c-faq__item__answer">
              ...
              <ul>
                <li>
                  First of all, you’re a student eligible to work under a student contract for 16
                  full days (128 hours).
                </li>
                <li>
          ...
          <div className="c-faq__item">
            ...
            <div className="c-faq__item__answer">
              <p>
                ...
                would like to join the movement and what you will bring to the table to make osoc
                great. Make sure to include your portfolio or some examples of your work as well.
                Based on your motivation, portfolio and your CV, a group of experienced osoc
                volunteers will match your unique set of skills and experiences with partner’s
                desired student profiles.
              </p>
            </div>
          </div>
        </div>
