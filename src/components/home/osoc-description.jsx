      ...
      <div className="small-12 large-5 cell">
        <div className="u-margin">
          <p className="intro-text">
            A 4-week summer programme in July, that provides Belgian based
            students the <strong>training</strong>, <strong>network</strong> and{' '}
            <strong>support</strong> necessary to transform{' '}
            <strong>open innovation projects</strong> into powerful real-world
            services.
          </p>
        </div>
      </div>
